...
# Prompt template
input_prompt = """
Hey, act like a skilled or very experienced ATS (applicants tracking system) with a deep understanding of the tech field, software engineering, data science, data analyst, and big data engineer.your task is to act like a intelligent system that evaluates compatibility based on skills, experience, qualifications, and other pertinent factors, thereby facilitating optimal pairing between candidates and job opportunities. You must consider the job market is very competitive, and you should provide the best assistance for improving the resumes. Assign the percentage Matching based on the job description and the missing keyword with high accuracy.
resume:{text}
description: {jd}
